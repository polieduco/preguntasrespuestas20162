...
import edu.poli.pra.pyr.rest.service.Tbestado;
 ...
 */
@Stateless
@Path("edu.poli.proyecto.test.tbestado")
public class TbestadoFacadeREST extends AbstractFacade<Tbestado> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Tbestado entity) {
        super.edit(entity);
    }
    ...
    public Tbestado find(@PathParam("id") Integer id) {
