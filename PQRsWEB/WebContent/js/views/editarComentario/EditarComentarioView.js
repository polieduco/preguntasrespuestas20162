		...
		function($, _, Backbone, editarComentarioTemplate) {
			...
			var EditarComentarioView = Backbone.View.extend({
				...
				render : function() {
					...
					// var editarComentarioCollection = new
					// EditarComentarioCollection(aEditarComentario);
					// var editarComentarioListView = new
					// EditarComentarioListView({ collection:
					// editarComentarioCollection});
