		...
		function($, _, Backbone, editarPreguntaTemplate) {
			...
			var EditarPreguntaView = Backbone.View.extend({
				...
				render : function() {
					...
					// var editarPreguntaCollection = new
					// EditarPreguntaCollection(aEditarPregunta);
					// var editarPreguntaListView = new EditarPreguntaListView({
					// collection: editarPreguntaCollection});
