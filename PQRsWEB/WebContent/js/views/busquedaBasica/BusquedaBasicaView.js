		...
		function($, _, Backbone, busquedaBasicaTemplate) {
			...
			var BusquedaBasicaView = Backbone.View.extend({
				...
				render : function() {
					...
					// var busquedaBasicaCollection = new
					// BusquedaBasicaCollection(aBusquedaBasica);
					// var busquedaBasicaListView = new BusquedaBasicaListView({
					// collection: busquedaBasicaCollection});
