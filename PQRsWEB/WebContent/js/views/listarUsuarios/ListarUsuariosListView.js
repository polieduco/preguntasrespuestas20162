 ...
 * 
 */
define([ 'jquery', 'underscore', 'backbone', 'models/usuario/usuarioModel',
		'collections/usuario/usuarioCollection',
		'text!templates/listarUsuarios/listarUsuariosListTemplate.html' ],
		function($, _, Backbone, usuarioModel, usuarioCollection,
				listarUsuariosListTemplate) {
			var ListarUsuariosListView = Backbone.View.extend({
				...
				render : function() {
					...
					var compiledTemplate = _.template(
							listarUsuariosListTemplate, data);
