 ...
 */
define(
		[ 'jquery', 'underscore', 'backbone', 'models/categoria/categoriaModel' ],
		function($, _, Backbone, categoriaModel) {// se extienden todos los
													// métodos y atributos //se
													// extienden todos los
													// métodos y atributos de la
													// clase Backbone.Model en
													// la coleccion actual
			var categoriaCollection = Backbone.Collection
					.extend({// valores predeterminados de la coleccion
								// actual
						// Parámetros que necesita el servidor
						model : categoriaModel,
						url : "http://localhost:9080/PQRsWEB/webresources/edu.poli.proyecto.test.tbcategoria",// direccion
																												// url
																												// de
																												// cada
																												// modelo
