...
], function($, _,Backbone, usuarioModel){//se extienden todos los métodos y atributos de la clase Backbone.Model en la coleccion actual 

var usuarioCollection = Backbone.Collection.extend({// valores predeterminados de la coleccion actual
	//Parámetros que necesita el servidor 
        model: usuarioModel,  
        url: "http://localhost:9080/PQRsWEB/webresources/edu.poli.proyecto.test.tbusuario",//direccion url de cada modelo y coleccion
