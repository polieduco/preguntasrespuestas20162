...
define([
 //librerias javascript
  ...
  'backbone',
  'models/rol/rolModel'
], function($, _,Backbone, rolModel){//se extienden todos los métodos y atributos de la clase Backbone.Model en la coleccion actual 

var rol = Backbone.Collection.extend({// valores predeterminados de la coleccion actual
 model: rolModel,   

        url: "http://localhost:9080/PQRsWEB/webresources/edu.poli.proyecto.test.tbrol",//direccion url de cada modelo y coleccion
