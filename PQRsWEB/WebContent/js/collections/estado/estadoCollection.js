...
define(
		[
		// librerias javascrip
		'jquery', 'underscore', 'backbone', 'models/estado/estadoModel' ],
		function($, _, Backbone, estadoModel) {// se extienden todos los
												// métodos y atributos //se
												// extienden todos los métodos y
												// atributos

			var estadoCollection = Backbone.Collection
					.extend({// valores predeterminados de la coleccion
								// actual
						model : estadoModel,
						// Parámetros que necesita el servidor
						url : "http://localhost:9080/PQRsWEB/webresources/edu.poli.proyecto.test.tbestado",// direccion
																											// url
																											// de
																											// cada
																											// modelo
