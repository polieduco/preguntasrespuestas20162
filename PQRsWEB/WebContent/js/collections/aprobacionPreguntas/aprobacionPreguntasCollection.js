...
], function($, _,Backbone, aprobacionPreguntaModel){//se extienden todos los métodos y atributos de la clase Backbone.Model en la coleccion actual 
	var aprobacionPreguntaCollection = Backbone.Collection.extend({// valores predeterminados de la coleccion actual
	    //Parámetros que necesita el servidor 
        model: aprobacionPreguntaModel,
        url: "http://localhost:9080/PQRsWEB/webresources/edu.poli.proyecto.test.tbaprobacionpreguntas",//direccion url de cada modelo y coleccion
