...
define(
		...
		'jquery', 'underscore', 'backbone', 'models/pregunta/preguntaModel' ],
		function($, _, Backbone, preguntaModel) {// se extienden todos los
			// métodos y atributos de la
			// clase Backbone.Model en
			// la coleccion actual

			var preguntaCollection = Backbone.Collection
					.extend({// valores predeterminados de la coleccion
						// actual
						model : preguntaModel,
						// Parámetros que necesita el servidor
						url : "http://localhost:9080/PQRsWEB/webresources/edu.poli.proyecto.test.tbpregunta",// direccion
						// url
						// de
						// cada
						// modelo
