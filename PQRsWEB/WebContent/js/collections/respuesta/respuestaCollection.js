...
], function($, _,Backbone, respuestaModel){//se extienden todos los métodos y atributos de la clase Backbone.Model en la coleccion actual 

var respuestaCollection = Backbone.Collection.extend({// valores predeterminados de la coleccion actual
	//Parámetros que necesita el servidor 
        model: respuestaModel, 
        url: "http://localhost:9080/PQRsWEB/webresources/edu.poli.proyecto.test.tbrespuesta", //direccion url de cada modelo y coleccion
