...
define(
		...
		function($, _, Backbone, areaAprobacionModel) { // se extienden todos
														// los métodos y
			...
			var areaAprobacion = Backbone.Collection
					.extend({

						model : models.areaAprobacion,
						url : "http://localhost:9080/PQRsWEB/webresources/edu.poli.proyecto.test.tbareaaprobacion", // direccion
																													// url
																													// de
																													// cada
																													// modelo
