...
], function($, _,Backbone, areaAprobacionModel){ //se extienden todos los métodos y atributos de la clase Backbone.Model en la coleccion actual           
	                                            // valores predeterminados de la coleccion actual
	                                           //Parámetros que necesita el servidor 
var areaAprobacion = Backbone.Collection.extend({

        model: models.areaAprobacion,
        url: "http://localhost:9080/PQRsWEB/webresources/edu.poli.proyecto.test.tbareaaprobacion", //direccion url de cada modelo y coleccion
