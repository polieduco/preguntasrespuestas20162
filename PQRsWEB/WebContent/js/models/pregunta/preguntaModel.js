...
define([
  ...
  var preguntaModel = Backbone.Model.extend({//se extienden todos los métodos y atributos de la clase Backbone.Model en el modelo actual.
        
	// valores predeterminados del modelo actual
	    urlRoot: "http://localhost:9080/PQRsWEB/webresources/edu.poli.proyecto.test.tbpregunta",//direccion url de cada modelo y coleccion
        ...
        toViewJson: function () {//contiene métodos para la creación y manipulación de objetos JSON como cadenas, objeto valor, 
            ...
            result.displayName = this.get('idpregunta');//Objeto valor es una cadena, número, booleano, nulo, objeto o arreglo
                                                        //devuelve un arreglo cuyos elementos correspondientes
