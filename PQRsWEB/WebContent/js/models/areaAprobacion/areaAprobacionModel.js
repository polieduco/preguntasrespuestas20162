...
define([
  ...
  'underscore',
  'backbone'
//se extienden todos los métodos y atributos de la clase Backbone.Model en el modelo actual.
], function(_,Backbone) {
  
  var areaAprobacionModel = Backbone.Model.extend({ // valores predeterminados del modelo actual
        urlRoot: "http://localhost:9080/PQRsWEB/webresources/edu.poli.proyecto.test.tbareaaprobacion", //direccion url de cada modelo y coleccion
