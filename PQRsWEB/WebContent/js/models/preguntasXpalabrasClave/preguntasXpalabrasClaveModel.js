...
//librerias javascript
  ...
  var preguntasxpalabrasclaveModel = Backbone.Model.extend({
	  // valores predeterminados del modelo actual
        urlRoot: "http://localhost:9080/PQRsWEB/webresources/edu.poli.proyecto.test.tbpreguntasxpalabrasclave",//direccion url de cada modelo y coleccion
        ...
        toViewJson: function () {//contiene métodos para la creación y manipulación de objetos JSON como cadenas, objeto valor, 
            ...
            result.displayName = this.get('idpreguntasxpalabrasclave');//devuelve un arreglo cuyos elementos correspondientes 
            return result;
        },
