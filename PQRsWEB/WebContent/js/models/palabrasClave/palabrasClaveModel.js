...
//librerias javascript
  ...
  var palabrasclaveModel = Backbone.Model.extend({
	// valores predeterminados del modelo actual
        urlRoot: "http://localhost:9080/PQRsWEB/webresources/edu.poli.proyecto.test.tbpalabrasclave",//direccion url de cada modelo y coleccion
        idAttribute: 'idclave',
        defaults: {
            palabraclave: ""
        },
        toViewJson: function () {// displayName property is used to render item in the list//se utiliza para procesar un elemento en una lista
            var result = this.toJSON(); 
            result.displayName = this.get('idclave');//devuelve un arreglo cuyos elementos correspondientes 
